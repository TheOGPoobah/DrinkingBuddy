...
public class EnergyActivity extends Activity {
    ...
    private String mongo_url = "https://api.mongolab.com/api/1/databases/drinkingbuddy/collections/energy?q={'id':";
            ...
            for(int i = 0; i < drinks.size(); i ++) {
                ...
                beer.setOnCardDismissedListener(new CardModel.OnCardDismissedListener() {
                    ...
                    public void onLike() {
                        ...
                        new AlertDialog.Builder(EnergyActivity.this)
                                ...
                                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        Intent intent = new Intent(EnergyActivity.this, TheDrinkActivity.class);
