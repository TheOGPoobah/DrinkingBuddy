...
public class SportsActivity extends Activity {
    ...
    private String mongo_url = "https://api.mongolab.com/api/1/databases/drinkingbuddy/collections/sports?q={'id':";
                        ...
                        new AlertDialog.Builder(SportsActivity.this)
                                ...
                                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        Intent intent = new Intent(SportsActivity.this, TheDrinkActivity.class);
